...
then
	if [ $verbose -eq 1 ]
	then
		seq 1.1 0.0185 2.94 | parallel ./logisticKernel.sh -v {}
		seq 2.95 $inc 4 | parallel ./logisticKernel.sh -v {}
	else
		seq 1.1 0.0185 2.94 | parallel ./logisticKernel.sh {}
		seq 2.95 $inc 4 | parallel ./logisticKernel.sh {}
	fi
else
